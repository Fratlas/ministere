...
class Database {
    ...
    private function insertSampleContent() {
        $contentItems = [
            ...
            ['document', 'Textes Réglementaires', 'Décrets', 'Projet de loi de finances pour l exercice 2025', 'Presentation detaillee du budget de l Etat pour l annee civile 2025, incluant les previsions de recettes et depenses.', null, '#', '4.2 MB', 'pdf', 1],
            ['document', "Rapports d'Activités", '2023', 'Rapport d activite annuel 2023 - Ministere des Finances', 'Bilan exhaustif des reformes engagees et des resultats macroeconomiques de la RDC durant l annee ecoulee.', null, '#', '12.8 MB', 'pdf', 2],
            ...
            ['document', 'Textes Réglementaires', 'Arrêtés', 'Arrete portant nomination des membres de la commission budgetaire', 'Decret officiel fixant la composition et les attributions de la commission technique de preparation budgetaire.', null, '#', '0.8 MB', 'pdf', 4],
