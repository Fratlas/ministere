...
function dgrad_image_url(array $item, int $index, array $fallbacks): string {
        ...
        <div class="row g-4 real-grid">
            <?php if (!empty($realisations)): ?>
                <?php foreach ($realisations as $index => $item): ?>
                    ...
                    $imageUrl = dgrad_image_url($item, $index, $fallbackImages);
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="real-empty">Aucune réalisation DGRAD publiée pour le moment. Ajoutez du contenu depuis l'administration.</div>
                </div>
            <?php endif; ?>
        </div>
    </main>
