<?php
// filepath: d:\ministre\app\views\realisations_dgrad.php
$title = 'Réalisations DGRAD - Ministère des Finances';

$extraHead = <<<'HTML'
<style>
    :root {
        --dgrad-green: #00a651;
        --dgrad-dark-green: #008c3d;
        --rdc-yellow: #f7d117;
        --rdc-red: #ce1021;
    }
    ...
    .btn-contact {
        background-color: var(--dgrad-green);
        color: white;
        border-radius: 5px;
        padding: 8px 20px;
        font-weight: 600;
    ...
    /* Hero Section */
    .hero-section-dgrad {
        background: linear-gradient(135deg, var(--dgrad-green) 0%, var(--dgrad-dark-green) 100%);
        color: white;
        padding: 80px 0;
        text-align: center;
        position: relative;
    }
    .hero-section-dgrad h1 {
        font-weight: 800;
        font-size: 3.5rem;
        margin-bottom: 20px;
    }
    .hero-section-dgrad p {
        font-size: 1.1rem;
        max-width: 700px;
        margin: 0 auto 30px;
        opacity: 0.9;
    ...
    .divider-green { background: var(--dgrad-green); flex: 1; }
    ...
    .card-header-title {
        background: linear-gradient(180deg, var(--dgrad-green) 0%, var(--dgrad-dark-green) 100%);
        color: white;
        padding: 20px;
        text-align: center;
        font-weight: 700;
    ...
    /* Footer */
    footer {
        background-color: var(--dgrad-dark-green);
        color: white;
        padding: 60px 0 0;
        margin-top: 80px;
        border-bottom: 10px solid;
        border-image: linear-gradient(to right, var(--dgrad-green) 33%, var(--rdc-yellow) 33% 66%, var(--rdc-red) 66%) 1;
    }
    .footer-logo {
        max-height: 50px;
        margin-bottom: 20px;
...
<!-- Hero Section -->
<header class="hero-section-dgrad">
    <div class="container">
...
<main class="container">
    <h2 class="section-title">Appui à la Direction Générale des Recettes Administratives, Domaniales et Participations (DGRAD)</h2>
    ...
    <div class="row">
        ...
        $dgradIconUrl = '/public/images/logo.webp';
        ?>
        <?php if (!empty($realisations)): ?>
            <?php foreach ($realisations as $index => $item): ?>
                ...
                $fallbackImage = $dgradLocalImages[$index % count($dgradLocalImages)];
                ...
                $iconUrl = $dgradIconUrl;
                $itemId = (int) ($item['id'] ?? 0);
                $detailUrl = 'detail.php?type=realisation_dgrad' . ($itemId > 0 ? '&id=' . $itemId : '');
                ?>
                <div class="col-md-6 col-lg-4">
                    <div class="realisation-card">
                        ...
                        <div class="p-3 text-center">
                            <a href="<?php echo htmlspecialchars($detailUrl); ?>" class="btn btn-sm btn-outline-success fw-bold">En savoir plus</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="realisation-card">
                    <div class="card-header-title">Modernisation du système de recouvrement</div>
                    <div class="card-img-container">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="realisation-card">
                    <div class="card-header-title">Digitalisation des services administratifs</div>
                    <div class="card-img-container">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="realisation-card">
                    <div class="card-header-title">Formation des agents DGRAD</div>
                    <div class="card-img-container">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="realisation-card">
                    <div class="card-header-title">Mise en place d'un ERP intégré</div>
                    <div class="card-img-container">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="realisation-card">
                    <div class="card-header-title">Centralisation des données domaniales</div>
                    <div class="card-img-container" style="background: linear-gradient(135deg, #00a651, #008c3d);">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="realisation-card">
                    <div class="card-header-title">Optimisation des processus de recouvrement</div>
                    <div class="card-img-container">
